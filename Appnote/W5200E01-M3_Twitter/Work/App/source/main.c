...
uint8 IP[4] = {222, 98, 173, 239};//IP Address
uint8 Gateway[4] = {222, 98, 173, 254};//Gateway Address
uint8 Subnet[4] = {255, 255, 255, 192};//SubnetMask Address
uint8 DNSServerIP[4] = {168, 126, 63, 1};//DNS Server Address
//uint8 IP[4] = {192, 168, 11, 129};//IP Address
